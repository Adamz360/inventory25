...
const chartDataDay = JSON.parse(document.getElementById('chart-data-day').textContent);

console.log(chartData)

document.addEventListener('DOMContentLoaded', () => {
    const { months, revenues, profits,expenses } = chartData;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const { days, revenues, profits, expenses } = chartDataDay;
